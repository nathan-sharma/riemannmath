          ...
          <div className="max-w-6xl mx-auto px-6 md:px-8 py-12 md:py-16 flex flex-col md:flex-row items-start md:items-center gap-8">
            ...
            <div className="flex-1">
              <p className="text-left text-gray-900 text-xl md:text-3xl leading-snug md:leading-relaxed font-sans">
                Riemann Math is a <span className = "font-bold">completely free</span> online competitive math tutoring service based in Katy, Texas, made for young math students. Our curriculum encompasses a broad range of advanced concepts, helping our students prepare for competitions such as the AMC 8, 10, 12, AIME, MATHCOUNTS, and more!
              </p>
            </div>
